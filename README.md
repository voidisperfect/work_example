...
Providing the code for this example excluding example of data cleaning and transformation, using old static dataset for the purpose of showcasing one of real tasks.
Analytics team has been using R before switching to Python.
